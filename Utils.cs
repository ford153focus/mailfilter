...
namespace Mailfilter {
    ...
    class Utils {
        ...
        public static void MoveMessage (string outputMessage, List<String> targetFolder, ImapClient client, IMailFolder inbox, int index) {
            /// Try create subfolder
            /// Get subfolder on error
            MailKit.IMailFolder currentFolder = client.GetFolder (client.PersonalNamespaces[0]);
