...
cd ~/Workspace/mailfilter && time ~/.local/opt/dotnet/dotnet publish --output bin/Release/linux-x64 --configuration Release --framework "net5.0" --runtime linux-x64 --self-contained --verbosity minimal /p:PublishTrimmed=true
